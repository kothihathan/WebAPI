...
namespace WebApi.Controllers
{
    ...
    public class MailsController : ControllerBase, IDisposable
    {
        ...
        public IActionResult GetFolder(int paramFolderId)
        {
            ...
            //Implemented below GetFolder function in mailservice class (service/data access layer to handle data execution tasks)
            var results = _mailService.GetFolder(paramFolderId, userId);
            return Ok(results);

            #region Commented below GetLabel because function was implemented in mailservice class (service/data access layer)
        ...
        public IActionResult GetLabel(int paramLabelId)
        {
            ...
            //Implemented below GetLabel function in mailservice class (service/data access layer to handle data execution tasks)
            var results = _mailService.GetLabel(paramLabelId, userId);
            return Ok(results);
        ...
        public IActionResult ResendMail(String paramMailId)
        {
            ...
            //Implemented below resendMail function in mailservice class (service/data access layer to handle data execution tasks)
            var result = _mailService.ResendMail(paramMailId, userId);
            if (!result.success)
            {                
            ...
            #region //Commented below resendMail because function was implemented in mailservice class (service/data access layer)
            // Begin transaction
        ...
        public IActionResult GetSentFolder(int paramFolderId, int pageNumber, int rowsOfPage)
        {
            ...
            var result = _mailService.GetSentFolder(paramFolderId, pageNumber, rowsOfPage);
            return Ok(result);
        }
    }
}
