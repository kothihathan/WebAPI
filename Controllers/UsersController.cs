...
namespace WebApi.Controllers
{
    ...
    public class UsersController : ControllerBase, IDisposable
    {
        ...
        public IActionResult GetAll()
        {
            ...
            #region Commented below function because function was implemented in mailservice class (service/data access layer)
            //var results = _context.UserModels.FromSqlRaw("Web_GetAllUsers").AsNoTracking().ToList();
            #endregion
            var results = _userService.GetAllWebUsers();
            return Ok(results);
        }
        ...
        public IActionResult GetAll(int UserID)
        {
            ...
            bool isAdmin = _userService.CheckIsAdmin(UserID);
            if (isAdmin)
            {
                var results = _context.UserModels.FromSqlRaw("Web_GetAllUsers").AsNoTracking().ToList();
                return Ok(results);
        ...
        public IActionResult GetById(int UserID)
        {
            ...
            //Implemented below GetUserModel_ByUserId function in mailservice class (service/data access layer to handle data execution tasks)
            var result = _userService.GetUserModel_ByUserId(UserID);
            return Ok(result);
        ...
        public IActionResult GetUserDetails()
        {
            ...
            //Implemented below GetUserDetails_ByUserId function in mailservice class (service/data access layer to handle data execution tasks)
            var result = _userService.GetUserDetails_ByUserId(userId);
            return Ok(result);
